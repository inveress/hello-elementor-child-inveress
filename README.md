# hello-elementor-child-inveress
A customised Hello Elementor child theme, adding optimisations and functionality.
...
= 1.0.1 - 2023-01-18 =
* Added initial standard Inveress functions.

= 1.0.2 - 2023-06-26 =
* Added additional standard functions.

= 1.0.3 - 2024-02-11 =
* Minor changes and fixes.

= 1.0.4 - 2026-02-23
* Updates to image size handling, script version handling, WooCommerce exceptions.
